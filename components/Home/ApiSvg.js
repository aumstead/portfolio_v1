    ...
    return (
        <div>
            ...
            >
                ...
                <path
                    d="m59.48 8c-2.52-3.63-6.73-6-11.48-6s-8.96 2.37-11.48 6c-.45.63-.84 1.3-1.17 2-.87 1.82-1.35 3.86-1.35 6 0 .68.05 1.35.15 2 .2 1.41.63 2.76 1.22 4h7.21 7.42c1.1 0 2 .9 2 2v4 1.41c3.07-.91 5.69-2.85 7.48-5.41 1.59-2.27 2.52-5.02 2.52-8 0-2.97-.93-5.73-2.52-8z"
                    fill="#47a2f2" // blue
                />
                <path
                    d="m52 29.41v30.59c0 1.1-.9 2-2 2h-46c-1.1 0-2-.9-2-2v-30h15l2-2h33z"
                    fill="#fff"
                />
                <path
                    d="m14 55v2c0 .55-.45 1-1 1h-6c-.55 0-1-.45-1-1v-2c0-.55.45-1 1-1h6c.55 0 1 .45 1 1z"
                    fill="#e177f2" //purple
                />
                <path
                    d="m26 55v2c0 .55-.45 1-1 1h-6c-.55 0-1-.45-1-1v-2c0-.55.45-1 1-1h6c.55 0 1 .45 1 1z"
                    fill="#e177f2" //purple
                />
                <path d="m34 32h14v14h-14z" fill="#50d890" />
                <path
                    d="m2 30v-6c0-1.1.9-2 2-2h31.37 7.21 7.42c1.1 0 2 .9 2 2v4h-33l-2 2z"
                    fill="#fff7b5" // yellow
                />
